package com.integrationlab.backend.aspect;

import com.integrationlab.backend.service.AuditTrailService;
import com.integrationlab.data.model.AuditTrail;
...
public class AuditAspect {
     ...
     */
    @Before("@annotation(com.integrationlab.backend.annotation.AuditUpdate) && args(id,..)")
     ...
     */
    @AfterReturning(
        pointcut = "@annotation(com.integrationlab.backend.annotation.AuditCreate)",
        returning = "result"
    )
     ...
     */
    @AfterReturning(
        pointcut = "@annotation(com.integrationlab.backend.annotation.AuditUpdate)",
        returning = "result"
    )
     ...
     */
    @Before("@annotation(com.integrationlab.backend.annotation.AuditDelete) && args(id,..)")
    ...
    public void auditAction(JoinPoint joinPoint, com.integrationlab.backend.annotation.AuditAction auditAction, Object result) {
        try {
            if (auditTrailService != null) {
