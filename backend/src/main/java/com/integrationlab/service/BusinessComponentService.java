...
public class BusinessComponentService {
    ...
    private BusinessComponentDTO toDTO(BusinessComponent businessComponent) {
        ...
        dto.setCreatedAt(businessComponent.getCreatedAt() != null ? businessComponent.getCreatedAt().format(DateTimeFormatter.ISO_DATE_TIME) : null);
        dto.setUpdatedAt(businessComponent.getUpdatedAt() != null ? businessComponent.getUpdatedAt().format(DateTimeFormatter.ISO_DATE_TIME) : null);
        return dto;
    }
}
